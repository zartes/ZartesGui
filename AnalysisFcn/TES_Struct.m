...
%                             continue;
                        ...
                        if ~isempty(filesNoise)
                            try
                                ...
                                eval(['obj.P' StrRange{k1} '(iOK).p(jj).ExRes = NaN;']);
                                eval(['obj.P' StrRange{k1} '(iOK).p(jj).ThRes = NaN;']);
                                eval(['obj.P' StrRange{k1} '(iOK).fileNoise(jj) = {[]};']);
                                eval(['obj.P' StrRange{k1} '(iOK).NoiseModel(jj) = {[]};']);
